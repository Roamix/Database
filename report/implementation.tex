...
but is stored through the \emph{Track} and \emph{RouteTracks} \todo{Change to 
RouteTrack}relations, exactly to ensure the table conforms to the first normal 
form. 
...
\subsection{Functionality} \label{sec:imp:func} % Other title?
